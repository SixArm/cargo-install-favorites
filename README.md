...
# ## Tracking
#
# * Command: https://github.com/sixarm/npm-install-favorites
# * Version: 1.4.0
# * Created: 2020-06-19T02:05:11Z
# * Updated: 2020-06-21T00:42:06Z
...
# HTML command line parser akin to `jq` for JSON
cargo install htmlq
...
# Terminal workspace multiplexer, akin to `screen` or `tmux`.
